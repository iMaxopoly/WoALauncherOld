...
QT_MOC_LITERAL(1, 8, 24), // "signal_download_progress"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "fetcher\0signal_download_progress\0"
};
...
void fetcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_download_progress((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (fetcher::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&fetcher::signal_download_progress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void fetcher::signal_download_progress(qint64 _t1, qint64 _t2)
{
